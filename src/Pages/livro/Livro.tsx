        ...
        <>
            <div className={style.livro}>
                <div className={style.detalhe}>
                    <h3 onClick={HandleClickHome} className={style.voltarTexto}> Detalhe do livro</h3>
                    <button onClick={HandleClickHome} className={style.voltar}>&lt;</button>
                </div>
            ...
            <button className={style.botao} onClick={Compra}><p>R${livro?.preco.toFixed(2)}</p><p>Adicione ao carrinho</p></button>
        </>
    )
}